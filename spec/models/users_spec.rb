...
RSpec.describe User, type: :model do
  describe 'Test user model for creating upadting and deleting user' do
    ...
    it 'expect user fail to save with repeated email' do
      new_user = User.new(name: 'tadesse alemayehu', email: 'testuser@testuser.com', password: '123456')
      new_user2 = User.new(name: 'tadesse alemayehu', email: 'testuser@testuser.com', password: '123456')
      new_user.save
      new_user2.save
